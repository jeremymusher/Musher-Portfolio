      ...
      <div className="projects-holder">
          ...
          <div className="project">
            ...
            <div className="blurb-links-holder">
                ...
                <br/>
                <a href="https://github.com/jeremymusher/Weather-Or-Not" target="_blank" rel="noreferrer">Repo</a>
                </div>
            </div>
          </div>
          ...
          <div className="project">
            ...
            <div className="blurb-links-holder">
                    ...
                    <div className="link-holder">
                        <a href="https://emergency-employee-finder.herokuapp.com/" target="_blank" rel="noreferrer">Live Link</a>
                        <br/>
                        <a href="https://github.com/NealGarcia/Project-3-Front-End" target="_blank" rel="noreferrer">Frontend Repo</a>
                        <br/>
                        <a href="https://github.com/NealGarcia/Project-3-Back-End" target="_blank" rel="noreferrer">Backend Repo</a>
                    </div>
            </div>
          </div>
          ...
          <div className="project">
            ...
            <div className="blurb-links-holder">
                ...
                <div className="link-holder">
                    <a href="https://musherweatherornot.herokuapp.com/" target="_blank" rel="noreferrer">Live Link</a>
                    <br/>
                    <a href="https://github.com/jeremymusher/DIY-frontend" target="_blank" rel="noreferrer">Frontend Repo</a>
                    <br/>
                    <a href="https://github.com/jeremymusher/DIY-backend" target="_blank" rel="noreferrer">Backend Repo</a>
                </div>
            </div>
          </div>
          ...
          <div className="project">
            ...
            <div className="blurb-links-holder">
                ...
                <div className="link-holder">
                    <a href="https://musher-memory.herokuapp.com/" target="_blank" rel="noreferrer">Live Link</a>
                    <br/>
                    <a href="https://github.com/jeremymusher/Flashcard-Memory-Game" target="_blank" rel="noreferrer">Repo</a>
                </div>
            </div>
          </div>
      </div>
